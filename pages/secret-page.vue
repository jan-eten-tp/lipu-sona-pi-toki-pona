<!-- this page just exists so the crawler properly works -->
<template>
    <article class="w-full flex items-center justify-center flex-col pb-40">
  ...
  const post = await queryContent('/en').findOne(); 
